...
class GenreTracksFragment : androidx.fragment.app.Fragment(){
    ...
    var url =
        Constants.rootURL + "?method=" + Constants.tracksSuffix + "&api_key=" + Constants.apiKey + "&format=json"

    lateinit var fragment: GenreTracksFragment
    ...
    fun albumsResponse(result: String) {
        ...
        if (result == null) {
            ...
            val genreData = genreObject.getJSONObject("tracks").getJSONArray("track")
    ...
    override fun onResume() {
        super.onResume()
        StaticClass.setGenreTracksFragment(this)
    }
}